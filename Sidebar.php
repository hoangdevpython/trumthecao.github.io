    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://Card6886.com/" target="_blank" class="nav-link">LIÊN HỆ</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="https://zalo.me/0365899114" target="_blank" class="nav-link">HỖ TRỢ ZALO</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="" target="_blank" class="nav-link">Vip Code</a>
                </li>
            </ul>
        </nav>
        <!-- /.navbar -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?=BASE_URL('Admin/Home');?>" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Tuấn Anh</span>
            </a>
